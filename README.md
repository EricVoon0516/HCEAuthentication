...
## Things You Need to Know before Downloading the Code File:
   ...
   2. Study the [`README.md`](https://github.com/EricVoon0516/HCEAuthentication/blob/bbd375988e1c878463f3124cf35a9e5a6d1b3a98/README.md) of this repository and supported documention regarding implementain of HCE before developing HCE application.
